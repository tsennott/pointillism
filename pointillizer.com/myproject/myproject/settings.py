"""
NOTE THIS FILE NEEDS CREDENTIALS AND WILL NOT RUN WITHOUT THEM
...
# Tell the staticfiles app to use S3Boto3 storage when
# writing the collected static files (when you run `collectstatic`).
